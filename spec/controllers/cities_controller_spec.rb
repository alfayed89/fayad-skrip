  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved city as @city" do
        ...
        post :create, {:city => { "nama" => "invalid value" }}, valid_session
        assigns(:city).should be_a_new(City)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested city" do
        ...
        City.any_instance.should_receive(:update_attributes).with({ "nama" => "MyString" })
        put :update, {:id => city.to_param, :city => { "nama" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the city as @city" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        City.any_instance.stub(:save).and_return(false)
        put :update, {:id => city.to_param, :city => { "nama" => "invalid value" }}, valid_session
        assigns(:city).should eq(city)
      end
